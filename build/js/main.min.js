...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var modalCloseButton = modalFeedback.querySelector('.modal__close-btn');
  ...
  introButton.addEventListener('click', function (event) {
    event.preventDefault();
    var elementId = introButton.getAttribute('href');
  ...
  var companyButton = companyWrapper.querySelector('.company__button');
