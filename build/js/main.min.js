...
/* harmony import */ var _modules_company_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/company-button */ "./js/modules/company-button.js");
/* harmony import */ var _modules_intro_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/intro-button */ "./js/modules/intro-button.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_intro_button__WEBPACK_IMPORTED_MODULE_5__["initIntroButton"])();
  Object(_modules_company_button__WEBPACK_IMPORTED_MODULE_4__["initCompanyButton"])();
...
// const feedbackModal = document.querySelector('[data-modal="feedback-modal"]');
// const modalForm = feedbackModal.querySelector('[name="modalform"]');
// const userName = feedbackModal.querySelector('[name="name"]');
// const userPhone = feedbackModal.querySelector('[name="tel"]');
// const agreement = feedbackModal.querySelector('[name="agreement"]');

// function validateModalForm() {
//   modalForm.addEventListener('submit', () => {
//     if (userName.value && userPhone.value && agreement.checked) {
