...
/* harmony import */ var _modules_company_button__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/company-button */ "./js/modules/company-button.js");
/* harmony import */ var _modules_intro_button__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/intro-button */ "./js/modules/intro-button.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_intro_button__WEBPACK_IMPORTED_MODULE_6__["initIntroButton"])();
  Object(_modules_company_button__WEBPACK_IMPORTED_MODULE_5__["initCompanyButton"])();
  ...
  var userNameModal = modalFeedback.querySelector('form input[type=text]');
  ...
  var userNameFeedback = formFeedback.querySelector('form input[type=text]');
  var userPhoneFeedback = formFeedback.querySelector('form input[type=tel]');
  var userPhoneModal = modalFeedback.querySelector('form input[type=tel]');
  var userQuestionFeedback = formFeedback.querySelector('form textarea');
  var userQuestionModal = modalFeedback.querySelector('form textarea');
  var setStorage = function setStorage(element, name, tel, question) {
    var userName = element.querySelector(name);
    var userPhone = element.querySelector(tel);
    var userQuestion = element.querySelector(question);
...
function initAccordion() {
  var accordionToggleList = document.querySelectorAll('.accordion__toggle');
  var accordionBodyList = document.querySelectorAll('.accordion__body');
  var accordionItemList = document.querySelectorAll('.accordion__item');
  accordionToggleList.forEach(function (item) {
    return item.classList.remove('no-js');
  });
  accordionBodyList.forEach(function (item) {
    return item.classList.remove('no-js');
  });
  function setTabIndex() {
    accordionItemList.forEach(function (item) {
...
/***/ "./js/modules/company-button.js":
/*!**************************************!*\
  !*** ./js/modules/company-button.js ***!
  \**************************************/
/*! exports provided: initCompanyButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initCompanyButton", function() { return initCompanyButton; });
// Company-button

function initCompanyButton() {
  var companyButton = document.querySelector('.company__button');
  var companyWrapper = document.querySelector('.company__wrapper');
...
/***/ "./js/modules/intro-button.js":
/*!************************************!*\
  !*** ./js/modules/intro-button.js ***!
  \************************************/
/*! exports provided: initIntroButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initIntroButton", function() { return initIntroButton; });
// Intro-button

function initIntroButton() {
  var introContainer = document.querySelector('.intro__container');
  var introButton = document.querySelector('.intro__container a');
  var scrollElement = document.querySelector('#feedbackForm');
  if (introButton !== null) {
